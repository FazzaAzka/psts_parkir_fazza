...
<div class="container">
    <h1>Tambah Data Kendaraan fazza</h1>
    <form>
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">no_plat</label>
  ...
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">no_tempat_parki</label>
    <input type="email" class="form-control" id="exampleInputEmail1">
  </div>
  <div class="mb-3">
